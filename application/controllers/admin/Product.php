...
class Product extends Admin_Controller {
    ...
    function add() {
        ...
        if ($this->input->post()) {
            $this->json_response = $this->Product_model->add($this->input->post(), $this->json_response);
    ...
    function delete(){
        if ($this->input->post()) {
            $this->json_response = $this->Product_model->delete($this->input->post(), $this->json_response);
            if ($this->input->is_ajax_request()) {
                echo json_encode($this->json_response);
                exit();
            } else {
    ...
    function detail_add($id){
        ...
        if ($this->input->post()) {
            ...
            if ($this->input->is_ajax_request()) {
                ...
                redirect('admin/product/detail_list');
            }
        }
        $this->load->view(ADMIN_LAYOUT, $data);
    }
