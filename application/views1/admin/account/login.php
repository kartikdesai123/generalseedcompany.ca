<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="<?php echo base_url() . 'account/login'; ?>" method="post">
        ...
        <!--                        <div class="create-account">
                                    <p>
                                        <a href="javascript:;" id="register-btn" class="uppercase">Subscription</a>
                                    </p>
                                </div>-->
    </form>
    <!-- END LOGIN FORM -->
    ...
    <form class="forget-form" action="#" method="post">
        ...
        <div class="form-group">
            <input class="form-control placeholder-no-fix" id="forgetemail" type="text" autocomplete="off" placeholder="Email" name="email" /> </div>
        <div class="form-actions">
