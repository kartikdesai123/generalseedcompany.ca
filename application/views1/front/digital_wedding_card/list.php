                    ...
                    <ul id="thumbs" class="fixclear" data-columns="4">
                        ...
                        <li class="item kl-has-overlay miscellaneous_sort web_sort even" data-date="02122016">
                            <div class="inner-item">
                                ...
                                <h4 class="title">
                                    <a href="<?= base_url(); ?>digital-wedding-card/detail">
                                ...
                                <div class="btnreadmorearea"><a href="<?= base_url(); ?>digital-wedding-card/detail" class="read_more"><i class="fa fa-plus"></i></a></div>
                                <div class="clear"></div>
                            </div>
                        </li>
                        <?php } ?>
