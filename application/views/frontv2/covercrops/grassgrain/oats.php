        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_GrassGrain_Oats.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Oats</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Great dual purpose grain</li>
                                    <li>Can be used for Cover Crop or feed</li>
                                    <li>Does not survive winters</li>
                                    <li>Holds soil from erosion</li>
                                </ul>
                            </div>
                        </div>
                    </div>
