        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_GrassGrain_SorghumSudangrass.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h2>Sorghum Sudangrass</h2>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Dense root system which penetrates compacted soil</li>
                                    <li>Quick growing with lots of organic matter</li>
                                    <li>Can be used for feed</li>
                                    <li>Easily winter-killed</li>
                                </ul>
                            </div>
                        </div>
                    </div>
