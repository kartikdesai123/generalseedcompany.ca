        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_GrassGrain_FallRye.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h2>Fall Rye</h2>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Fast growing and very hardy</li>
                                    <li>Tolerant of poor soil conditions</li>
                                    <li>Fights soil erosion</li>
                                    <li>Suppress weeds</li>
                                    <li>Helps control soil erosion</li>
                                </ul>
                            </div>
                        </div>
                    </div>
