        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_GrassGrain_AnnualRyeGrass.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h2>Annual Ryegrass</h2>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Cost effective ryegrass for interseeding</li>
                                    <li>Very fibrous aggressive roots</li>
                                    <li>Increase water infiltration</li>
                                    <li>Erosion control</li>
                                    <li>Can be pastured</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-5 col-xs-6">
                                <div class="square-box withscroll">
                                    ...
                                    <div class="square-box-value">
                                        Spring/Mid-Summer/Late-Summer/Fall (bar goes fully through Spring, Mid and Late-Summer)
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-6">
