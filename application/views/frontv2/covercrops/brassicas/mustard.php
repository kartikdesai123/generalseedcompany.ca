        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Brassicas_Mustard.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Mustard</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>New and improved varieties are used as biofumigants</li>
                                    <li>Yellow and Oriental mustard varieties are high in glucosinolates</li>
                                    <li>Brown mustard helps control wireworms</li>
                                    <li>Increase organic matter</li>
                                    <li>We stock Pacific Gold, Oriental, and Brown Mustard
                                </ul>
                            </div>
                        </div>
                    </div>
