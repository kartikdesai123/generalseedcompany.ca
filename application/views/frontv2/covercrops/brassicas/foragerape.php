        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Brassicas_ForageRape.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Forage Rape (Essex)</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Deep, fibrous root system</li>
                                    <li>Great scavenger for nitrogen and soluble phosphorus</li>
                                    <li>Very drought tolerant brassica</li>
                                    <li>Can be grazed if needed</li>
                                </ul>
                            </div>
                        </div>
                    </div>
