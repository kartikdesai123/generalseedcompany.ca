        ...
        <div class="row">
            <aside class="col-sm-3">
                <div class="sidebar">
                    ...
                    <?php $this->load->view('frontv2/covercrops/legumes/leftsidebar'); ?>
                </div>
            </aside>
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Legumes_ForagePeas.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Forage Peas</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Aggressive growth to suppress weeds</li>
                                    <li>Produces significant amounts of nitrogen</li>
                                    <li>Great item to be used in a Cover Crop mixture</li>
                                    <li>Great item to be used as a Forage Crop</li>
                                    <li>Does not survive winter</li>
                                </ul>
                            </div>
                        </div>
                    </div>
