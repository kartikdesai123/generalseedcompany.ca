        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Brassicas_NitroRadish.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Nitro Radish</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Scavenges Nutrients</li>
                                    <li>Reduces soil compaction</li>
                                    <li>Promotes water infiltration</li>
                                    <li>Increases earthworm activity</li>
                                    <li>Improves soil biology</li>
