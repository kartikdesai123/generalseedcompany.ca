        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Legumes_BerseemClover.jpg" alt="Category images" class="img-responsive">
                    <div class="content-intro">
                        <h1>Berseem Clover</h1>
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    <li>Berseem Clover</li>
                                    <li>Low growing cover crop</li>
                                    <li>Grows upright with a white flower</li>
                                    <li>Produces significant amounts of nitrogen</li>
                                    <li>Can grow 12 - 16 inches tall</li>
                                </ul>
                            </div>
                        </div>
                    </div>
