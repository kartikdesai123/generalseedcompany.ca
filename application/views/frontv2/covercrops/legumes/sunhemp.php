        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="content-main">
                    <img src="<?= base_url(); ?>public/frontv2/images/cover_crops/CoverCrops_Legumes_SunHemp.jpg" alt="Category images" class="img-responsive">
                        ...
                        <div class="row ">
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <ul class="list-value">
                                    ...
                                    <li>Can produce large amounts of biomass per acre</li>
                                    <li>Can be used as a great feed source</li>
                                    <li>Shows some nematode suppression</li>
                                </ul>
                            </div>
                        </div>
                    </div>
