                    ...
                    <div class="available-list-category">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box withscroll">
                                    ...
                                    <div class="square-box-value">
                                        Sand | Loam | Clay (bar goes partly through Sand, and fully through Loam and Clay)
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Alsike Clover</h3>
                                <ul class="list-value">
                                    <li>Economically priced</li>
                                    <li>Small pink flower</li>
                                    <li>Likes low PH soils</li>
