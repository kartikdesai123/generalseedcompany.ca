                        ...
                        <div class="row mb-25">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box">
                                    ...
                                    <div class="square-box-value">
                                        1/4 - 3/4 <b class="inches">Inches</b>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                            ...
                            <div class="col-sm-12 col-xs-12 mb-30-xs">
                                <div class="row ">
                                    <div class="col-sm-6 col-xs-12 mb-30-xs">
                                        <h3 class="title-with-border mb-15">AAC Mountainview</h3>
                                    </div>
                                </div>
                                <ul class="list-value">
                                    <li>15% more yield then the average Sainfoin varieties</li>
                                    <li>Handles lower PH soils better than other Sainfoin varieties</li>
                                    <li>Quick regrowth after pasturing</li>
                                    <li>Deeply set crowns</li>
                                </ul>
                            </div>
                        </div>
                    </div>
