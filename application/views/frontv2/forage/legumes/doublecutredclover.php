                    ...
                    <div class="available-list-category">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box withscroll">
                                    ...
                                    <div class="square-box-value">
                                        Sand | Loam | Clay (bar goes slightly through Sand, and fully through Loam and Clay)
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Bigfoot Red Clover</h3>
                                <ul class="list-value">
                                    <li>Large leafy Forage Red Clover variety</li>
                                    <li>Very high leaf to stem ratio</li>
                                    <li>Ideal for haylage production</li>
                                    <li>3 to 4 year stand variety</li>
                                </ul>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <h3 class="title-with-border">Double Cut Red Clover</h3>
                                <ul class="list-value">
                                    <li>2-year Red Clover</li>
                                    <li>Ideal for Cover Crops</li>
                                    <li>Economically priced variety</li>
                                    <li>Canadian and Oregon grown</li>
                                </ul>
                            </div>
                        </div>
                    </div>
