                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Leo Trefoil</h3>
                                <ul class="list-value">
                                    <li>Quick recovery after harvesting</li>
                                    <li>Upright forage type</li>
                                    <li>Bred and developed in Canada</li>
                                    <li>Bloat-free pasture</li>

                                </ul>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <h3 class="title-with-border">Birdsfoot Trefoil</h3>
                                <ul class="list-value">
                                    <li>Good winter-hardiness</li>
                                    <li>High flooding tolerance</li>
                                    <li>Bloat-free pasture</li>
                                    <li>Canadian grown seed</li>
