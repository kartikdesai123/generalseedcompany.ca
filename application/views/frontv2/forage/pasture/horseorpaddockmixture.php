            ...
            <div class="col-sm-9">
                <div class="content-main">
                    ...
                    <div class="available-list-category">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box withscroll">
                                    ...
                                    <div class="square-box-value">
                                        Sand | Loam | Clay (bar goes fully through all the sections)
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="row ">
                            <div class="col-sm-7 col-xs-12 mb-30-xs">
                                <h3 class="title-with-border mb-15">P4 Horse or Paddock Mixture</h3>
                                <ul class="list-value">
                                    <li>30% Treasure Timothy</li>
                                    <li>25% Yukon Tall Fescue</li> 
                                    <li>15% Tetrasweet Perennial Ryegrass</li>
                                    <li>15% Kentucky Bluegrass</li>
                                     <li>10% Devour Orchardgrass</li>
