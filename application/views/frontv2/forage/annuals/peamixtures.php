                    ...
                    <div class="available-list-category">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box">
                                    ...
                                    <div class="square-box-value">
                                        Spring/Mid-Summer/Late-Summer/Fall (bar goes through all of Spring to all of Late-Summer)
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box">
                                    ...
                                    <div class="square-box-value">
                                        3/4 - 1 <strong class="inches">inch</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box">
                                    ...
                                    <div class="square-box-value">
                                        2 <strong class="inches">Inches</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Pea Mixtures</h3>
                                <ul class="list-value">
                                    <li>55% Oats / 45% Forage Peas</li>
                                    <li>55% Oats / 45% Forage Peas</li>
                                    <li>30% Oats / 30% Barley / 40% Forage Peas</li>
                                    <li>50% Triticale / 50% Forage Peas</li>
                                 </ul>
                            </div>
