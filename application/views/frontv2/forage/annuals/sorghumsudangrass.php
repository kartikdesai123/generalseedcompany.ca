                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Xtragraze BMR Brand Sorghum Sudangrass</h3>
                                <ul class="list-value">
                                    <li>BMR 6 Low Lignin Variety</li>
                                    <li>Extremely high leaf to stem ratio</li>
                                    <li>High sugar content</li>
                                    <li>Enhanced drought tolerance</li>
                                 </ul>
                            </div>
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Sorghum Sudangrass</h3>
                                <ul class="list-value">
                                   
                                    <li>Amazing return on yield vs investment cost</li>
                                     <li>Traditional style Sorghum Sudangrass variety</li>
                                    <li>Multiple cuttings</li>
                                    <li>Superior regrowth potential</li>
                                 </ul>
                            </div>
