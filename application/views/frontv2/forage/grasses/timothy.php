                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Treasure Timothy</h3>
                                <ul class="list-value">
                                    <li>Yield with exceptional regrowth</li>
                                    <li>Unmatched bales per acre </li>
                                    <li>Very wide leaves</li>
                                    <li>Medium maturity</li>
                                    
                                </ul>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <h3 class="title-with-border">Climax Timothy</h3>
                                <ul class="list-value">
                                    <li>Long Timothy heads</li>                                   
                                    <li>Very little regrowth</li>
                                    <li>Late maturity</li>
