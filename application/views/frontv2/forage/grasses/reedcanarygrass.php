                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Palaton Reed Canary Grass</h3>
                                <ul class="list-value">
                                    <li>Low alkaloid variety</li>
                                    <li>Leafy, high-yielding, long-living Perennial Forage Grass</li>
                                    <li>Performs well on wet, poorly drained soil</li>
                                    <li>Can be used for hay or pasture</li>
