                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">Fleet Meadow Bromegrass</h3>
                                <ul class="list-value">
                                    <li>Quick regrowth after grazing</li>
                                    <li>Superior winter-hardiness</li>
                                    <li>High forage yield</li>
                                    <li>Early spring green up </li>
                                </ul>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <h3 class="title-with-border">Meadow Bromegrass</h3>
                                <ul class="list-value">
                                    <li>Used in pasture situations</li>
                                    <li>Good winter-hardiness</li>
                                    <li>Leafy</li>
