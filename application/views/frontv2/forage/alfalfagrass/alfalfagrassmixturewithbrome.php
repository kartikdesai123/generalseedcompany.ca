                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-7 col-xs-7 mb-30-xs">
                                <h3 class="title-with-border mb-15">AG4: Alfalfa Grass Mixture with Brome</h3>
                                <ul class="list-value">
                                    <li>70% **__________ Alfalfa</li>
                                    <li>10% Treasure Timothy</li>
                                    <li>3% Tetrasweet Perennial Ryegrass</li>
                                    <li>3% Alpine II Orchardgrass</li>
                                    <li>14% Carlton Bromegrass</li>
                                 </ul>
                            </div>
                        </div>
