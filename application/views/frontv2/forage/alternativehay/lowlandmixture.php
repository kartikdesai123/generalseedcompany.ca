                    ...
                    <div class="available-list-category">
                            ...
                            <div class="col-sm-3 col-xs-6">
                                <div class="square-box withscroll">
                                    ...
                                    <div class="square-box-value">
                                        Sand | Loam | Clay (bar starts half way through sand and all of loam and clay) 
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">A3: Lowland (Brome)</h3>
                                <ul class="list-value">
                                    <li>50% BF Trefoil
                                    </li><li>3% Ladino Clover	
                                    </li><li>2% DC Red Clover	
                                    </li><li>5% Alsike Clover	
                                    </li><li>15% Treasure Timothy	
                                    </li><li>5% Palaton Reed Canary Grass	
                                    </li><li>5% Tetrasweet Perennial Ryegrass	
                                    </li><li>15% Smooth Bromegrass	
                                    </li>
                                 </ul>
                            </div>
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">A3: Lowland (No Brome)</h3>
                                <ul class="list-value">
                                    <li>55% BF Trefoil
                                    </li><li>3% Ladino Clover	
                                    </li><li>2% DC Red Clover	
                                    </li><li>5% Alsike Clover	
                                    </li><li>20% Treasure Timothy
                                    </li><li>10% Palaton Reed Canary Grass
                                    </li><li>5% Tetrasweet Perennial Ryegrass
                                    </li>
                                 </ul>
                            </div>
