                    ...
                    <div class="available-list-category">
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">A1: Hay & Pasture (Brome)</h3>
                                <ul class="list-value">
                                    <li>52% Haygrazer Alfalfa</li>
                                    ...
                                    <li>20% Smooth Bromegrass</li>

                                 </ul>
                            </div>
                            <div class="col-sm-6 col-xs-6 mb-30-xs">
                                <h3 class="title-with-border mb-15">A1: Hay & Pasture (No Brome)</h3>
                                <ul class="list-value">
                                    <li>62% Haygrazer Alfalfa</li>
                                    <li>1% Ladino Clover</li>
                                    <li>1% White Clover</li>
                                    <li>2% DC Red Clover</li>
                                    <li>2% Alsike Clover</li>
                                    <li>22% Treasure Timothy</li>
                                    <li>5% Tundra Late Orchardgrass</li>
                                    <li>5% Tetrasweet Perennial Ryegrass</li>
