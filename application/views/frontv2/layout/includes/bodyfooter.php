    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 col-sm-8 col-xs-12 gsc-footer-info footer-col-2">
                ...
                <p>email: <a href="mailto:generalseedcompany@gmail.com" style="text-transform: lowercase;" target="_blank">generalseedcompany@gmail.com</a></p>
            </div>
            <div class="col-md-5 col-xs-12 col-sm-12 footer-col-3">
                ...
                <a href="<?= base_url(); ?>products/contact-us" title="Contact Us" class="btn">Contact Us</a>
            </div>	
        </div>
    </div>
</footer>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <p>Copyrights © 2018 general seed Company. All rights reserved.</p>
